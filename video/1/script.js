...
const update3 = function () {
 ...
 //               x/16
            ...
            this.plasma[y][x] = returnColor(c, 40)
        }
    }
}
...
const update4 = function () {
    ...
    for (let y = 0; y < this.HEIGHT; y++) {
        for (let x = 0; x < this.WIDTH; x++) {
            ...
            let b = getSin(x /2 + t / 10, 80)

            let d = getSin(y/2.5, 40)

            const c = returnEnvelope([0, 20, 50, 80], x) *a
                        + returnEnvelope([100, 120, 150, 200], x) *b
                        + returnEnvelope([30, 45, 55, 150], x) *d
...
const cuadros = [
    //new Plasma(200, 80, defaultColor, update6, column1, ["blue", "small"]),
    //new Plasma(400, 150, defaultColor, update4, column1, ["green", "small"]),
    //new Plasma(80, 40, colorBig , updateBig, column3, [, "big"]),
